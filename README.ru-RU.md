...
- [Использование](#использование)
  - [AuthArgs](#пример-инициализации-с-authargs)
  - [URLArgs](#пример-инициализации-с-urlargs)
  - [Дополнительные параметры](#дополнительные-параметры)
- [Создание миграций](#создание-миграций)
- [Выполнение миграций](#выполнение-миграций)
- [Синхронизация миграций](#синхронизация-миграций-между-проектами--серверами)
...
При работе с репозиторием, пожалуйста, установите pre-commit для проведения автоматического форматирования кода перед пул реквестом

```bash
pip install pre-commit
```

Вы можете использовать Makefile для установки зависимостей для тестирования в .venv и проведения тестирования
...
Затем можете запустить тестирование:
```bash
make test
```

Так же Вы можете установить в .venv текущую версию пакета с отслеживанием изменений:
```bash
make dev
```
